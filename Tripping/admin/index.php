            ...
            <div class="card-body">
              ...
              <div class="media-body">
                ...
                <h4 id="totaluser" class="text-white line-height-5">
                  <?php  echo $totaluser=$d->count_data_direct("user_id","tbl_user",""); ?>
                </h4>
              </div>
          ...
          <div class="card gradient-deepblue">
            <div class="card-body">
              ...
              <div class="media-body">
                ...
                <h4 id="totalvendor" class="text-white line-height-5">   <?php  echo $totalvendor=$d->count_data_direct("vendor_id","tbl_vendor",""); ?></h4>
              </div>
              <div class="w-circle-icon rounded-circle border border-white">
                <i class="fa fa-users text-white"></i></div>
            </div>
          ...
          <div class="card gradient-orange">
            <div class="card-body">
              ...
              <div class="media-body">
                ...
                <h4 id="totalpackage" class="text-white line-height-5"> <?php  echo $totalpackage=$d->count_data_direct("package_id","tbl_package",""); ?></h4>
              </div>
              <div class="w-circle-icon rounded-circle border border-white">
