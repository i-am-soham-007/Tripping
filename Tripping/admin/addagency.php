              ...
              <form id="personal-info" action="controller/agencyController.php" method="post" enctype="multipart/form-data">
                <h4 class="form-header text-uppercase">
                 ...
                 <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">admin Name</label>
                  <div class="col-sm-10">
                      <select class="form-control" id="input-1" name="admin_id" required="">
                               <?php 
                      $q=$d->select("tbl_admin","$role_id=role_id");
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="file"  id="input-4"  name="agency_logo" required>
                  </div>
                </div>

                <?php if(isset($updateagency))
{
  ?>
