      ...
      <div class="col-lg-4">
       <div class="card profile-card-2">
        ...
        <div class="card-body pt-5">
          <img src="../images/V_profile/<?php echo $_SESSION['vendor_profile']; ?>" alt="profile-image" class="profile" id="blah">
          <h5 class="card-title"><?php echo $_SESSION['vendor_name']; ?></h5>
        ...
        <div class="card-body border-top">
         <div class="media align-items-center">
           ...
           <div class="media-body text-left ml-3">
             <div class="progress-wrapper">
               <p class="text-muted"><?php echo $_SESSION['vendor_mobile'] ?> </p>
             </div>                   
           </div>
         </div>
         <hr>
         ...
         <div class="media align-items-center">
           ...
           <div class="media-body text-left ml-3">
             <div class="progress-wrapper">
               <p class="text-muted"><?php echo $_SESSION['vendor_email'] ?> </p>
          ...
          <div class="tab-pane" id="edit">
            <form action="controller/profileController.php" method="post" enctype="multipart/form-data">
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input class="form-control" name="vendor_name" type="text" value="<?php echo $_SESSION['vendor_name'] ?>">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input class="form-control" type="text" maxlength="10" minlength="10" name="vendor_mobile" value="<?php echo $_SESSION['vendor_mobile'] ?>">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Change profile</label>
                <div class="col-lg-9">
                  <input name="vendor_profile" id="imgInp" class="form-control" type="file">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  ...
                  <input name="updateProfile" type="submit" class="btn btn-primary" value="Update Profile">
                </div>
              </div>
            </form>
          </div>
