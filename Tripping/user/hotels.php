                    ...
                    <div class="col-sm-3">
                      <div class="thumb6">
                        <div class="thumbnail clearfix">
                          <figure>
                            <img src="../images/Hotels/<?php echo $hotel_image; ?>" alt="" class="img-responsive">
                            <div class="over">
                              <div class="v1"><?php echo $hotel_name; ?></div>
                              <div class="v2"><?php echo $hotel_description; ?></div>
                            </div>
                          </figure>
                          <div class="caption">
                            <div class="txt1"><?php echo $hotel_name; ?></div>
                            <div class="txt3 clearfix">
                              <div class="left_side">
                                <div class="price"><?php echo $hotel_amount; ?></div>
