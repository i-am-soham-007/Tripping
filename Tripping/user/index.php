    ...
    <div class="tabs_wrapper tabs1_wrapper">
      <div class="tabs tabs1">
        <div class="tabs_tabs tabs1_tabs">
            ...
            <ul>
              <li class="active flights"><a href="#tabs-1">bus</a></li>
        ...
        <div class="tabs_content tabs1_content">
            ...
            <div id="tabs-1">
              <form action="controller/searchController.php" method="POST" class="form1">
                <div class="row">
                  <div class="col-sm-4 col-md-2">
                    <div class="select1_wrapper">
                      <label> from:</label>
                      <div class="select1_inner">
                        <select class="select2 select" name="name_search" style="width: 100%">
                  ...
                  <div class="col-sm-4 col-md-2">
                    <div class="select1_wrapper">
                      <label>To:</label>
                      <div class="select1_inner">
                        <select class="select2 select" name="search2" style="width: 100%">
                          <option value="1">City or Airport</option>
                         <!--  <?php
                           $q=$d->select("tbl_city","","");
                           $i=0;
                          ...
                          $i++;
  ?> -->
                        <!--   <option value="2"><?php// echo $city_name;/*print_r($row)*/; ?></option>
                  ...
                  <div class="col-sm-4 col-md-2">
                    <div class="button1_wrapper">
                      <button type="submit" name="search" class="btn-default btn-form1-submit">Search</button>
                    </div>
                  </div>
                </div>
              </form>
...
<div id="popular_cruises1">
  <div class="container">
    ...
    <div class="title1 animated" data-animation="fadeInUp" data-animation-delay="200">Popular Trip List are available , Enjoy the full journey of travelling. Lots of Trips Are available here.</div>
                      ...
                      <li>
                        <div class="popular">
                          <div class="popular_inner">
                            <figure>
                              <img src="../images/Packages/<?php echo $package_gallery;?>" height="60" width="80" class="img-responsive">
                              <div class="over">
                            ...
                            <div class="caption">
                              ...
                              <div class="txt3 clearfix">
                                ...
                                <div class="right_side">
                                  ...
                                  <button class="btn-default btn1" name="detail">See All</button>
                                  </div>
                                </form>
                              </div>
                            </div>
...
<div id="why1">
  <div class="container">
    ...
    <div class="title1 animated" data-animation="fadeInUp" data-animation-delay="200"></div>
